                                ...
                                <div class="flex flex-wrap ">
                                    ...
                                    <button class="btn inline-flex justify-center btn-dark dark:bg-slate-700 dark:text-slate-300 m-1 ">
                                        <span class="flex items-center">
                                            ...
                                            <a href="{{ route('register') }}" class="navItem"><span>Add New Customer</span></a>
                                        </span>
                                    </button>
                                </div>
                            </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="card">
                                            <div class="card-body px-6 rounded overflow-hidden">
                                                            ...
                                                            <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 ">
                                                                ...
                                                                <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                                    <tr class="even:bg-slate-50 dark:even:bg-slate-700">
                                                                        ...
                                                                        <td class="table-td">
                                                                            <span
                                                                                class="block date-text">2022-10-03</span>
                                                                        </td>
                                                                        <td class="table-td">
                                                                            <span
                                                                                class="block date-text">2022-10-10</span>
                                                                        </td>
                                                                        <td class="table-td">
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <img src="assets/images/post/c1.png"
                                                                                        alt="Image"
                                                                                        class="w-full h-full rounded-full">
                                                                                </div>
                                                                                <div
                                                                                    class="h-6 w-6 rounded-full ring-1 ring-slate-100">
                                                                                    <img src="assets/images/post/c2.png"
                                                                                        alt="Image"
                                                                                        class="w-full h-full rounded-full">
                                                                                </div>
                                                                                <div
                                                                                    class="h-6 w-6 rounded-full ring-1 ring-slate-100">
                                                                                    <img src="assets/images/post/c3.png"
                                                                                        alt="Image"
                                                                                        class="w-full h-full rounded-full">
                                                                                </div>
                                                                                <div
                                                ...
                                                <div
                                                    class=" flex flex-wrap items-center justify-between space-x-2 py-4">
                                                    <div>
                                                        <div
                                                    ...
                                                    <div class="card-text h-full space-y-10">
                                                        <ul class="list-none">
                                                            <li class="inline-block">
                                                                <a href="#" class="flex items-center justify-center w-6 h-6 bg-slate-100 dark:bg-slate-700 dark:hover:bg-black-500 text-slate-800dark:text-white rounded mx-1 hover:bg-black-500 hover:text-white text-sm font-Inter font-medium transition-allduration-300 relative top-[2px] pl-2">
                                                                    <iconify-icon
                                                            ...
                                                            <li class="inline-block">
                                                                <a href="#" class="flex items-center justify-center w-6 h-6 bg-slate-100 dark:bg-slate-700 dark:hover:bg-black-500 text-slate-800dark:text-white rounded mx-1 hover:bg-black-500 hover:text-white text-sm font-Inter font-medium transition-allduration-300 p-active">
                                                                    1</a>
                                                            </li>
                                                            <li class="inline-block">
                                                                <a href="#" class="flex items-center justify-center w-6 h-6 bg-slate-100 dark:bg-slate-700 dark:hover:bg-black-500 text-slate-800dark:text-white rounded mx-1 hover:bg-black-500 hover:text-white text-sm font-Inter font-medium transition-all duration-300 ">
                                                                    2</a>
                                                            </li>
                                                            <li class="inline-block">
                                                                <a href="#" class="flex items-center justify-center w-6 h-6 bg-slate-100 dark:bg-slate-700 dark:hover:bg-black-500 text-slate-800dark:text-white rounded mx-1 hover:bg-black-500 hover:text-white text-sm font-Inter font-medium transition-all duration-300 relative top-[2px]">
                                                                    <iconify-icon
                                                ...
                                                <div>
                                                    ...
                                                    <div class="flex justify-start -space-x-1.5 rtl:space-x-reverse">
                                                        <div class="h-6 w-6 rounded-full ring-1 ring-slate-100">
                                                            <img src="assets/images/post/c1.png" alt="Image"
                                                                class="w-full h-full rounded-full">
                                                        </div>
                                                        <div class="h-6 w-6 rounded-full ring-1 ring-slate-100">
                                                            <img src="assets/images/post/c2.png" alt="Image"
                                                                class="w-full h-full rounded-full">
                                                        </div>
                                                        <div class="h-6 w-6 rounded-full ring-1 ring-slate-100">
                                                            <img src="assets/images/post/c3.png" alt="Image"
                                                                class="w-full h-full rounded-full">
                                                        </div>
                                                        <div
                                                            class="bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-300 text-xs ring-2 ring-slate-100 dark:ring-slate-700 rounded-full h-6 w-6 flex flex-col justify-center items-center">
                                        ...
                                        <div
                                            ...
                                            <header class="flex justify-between items-end">
                                                ...
                                                <div>
                                                    <div class="dropstart relative">
                                                        <button class="inline-flex justify-center items-center"
                                                            type="button" id="tableDropdownMenuButton4"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <iconify-icon class="text-xl ltr:ml-2 rtl:mr-2"
                                                                icon="heroicons-outline:dots-vertical"></iconify-icon>
                                                        </button>
                                                ...
                                                <form class="flex flex-col space-y-3">
                                                    <div class="input-area">
                                                        ...
                                                        <span id="nameErrorMsg"
                                                            class="font-Inter text-sm text-danger-500 pt-2 hidden mt-1">This
                                                            is valid state.</span>
                                                    </div>
                                                    <div class="flex items-center justify-between space-x-4">
                                                        <div class="w-full">
                                                            <label for="default-picker" class=" form-label">Start
                                                                Date</label>
                                                            <input
                                                        ...
                                                        <div class="w-full">
                                                            <label for="default-picker" class=" form-label">End
                                                                Date</label>
                                                            <input
                                                                class="form-control py-2 flatpickr flatpickr-input active"
                                                                id="default-picker" value="" type="text"

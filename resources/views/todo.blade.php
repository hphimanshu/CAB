                                            ...
                                            <div class="card-body py-6 h-full flex flex-col">
                                                ...
                                                <div class="h-full px-6 " data-simplebar="data-simplebar">
                                                    <ul class="todo-categories list mt-6">
                                                        ...
                                                        <li class="email-categorie-list" data-status="done">
                                                            <label>
                                                                <span class="flex-1 flex space-x-2 rtl:space-x-reverse">
                                                                    <span class="text-xl">
                                                                        <iconify-icon icon=heroicons:document-check>
                                                                        </iconify-icon>
                                                                    </span>
                                                                    <span class="capitalize text-sm">
                                                                        Completed
                                                    ...
                                                    <ul class="todo-categories list">
                                                        ...
                                                        <li data-status="team"
                                                            class="flex space-x-2 text-sm capitalize dark:text-slate-300 py-2 cursor-pointer items-center rtl:space-x-reverse email-categorie-list">
      ...
      w-2 rounded-full ring-opacity-30 transition-all duration-150 "></span>
        ...
        border-slate-100 dark:border-slate-700 rounded-t-md">
                ...
                items-center ltr:mr-3 rlt:ml-3 lg:hidden md:text-base text-sm rounded-full cursor-pointer">
                                                            <iconify-icon icon="heroicons-outline:menu-alt-2">
                                                            </iconify-icon>
                                                        </div>
                                                        <div
                                                            class="max-w-[180px] flex items-center space-x-1 rtl:space-x-reverse leading-[0]">
                                                            <div class="dark:text-slate-300">
                                                                <iconify-icon icon="heroicons-outline:search">
                                                                </iconify-icon>
                                                            </div>
                                                            <div>
                                                                <input type="text" id="todo-search"
                                                                    placeholder="Search Email" class="bg-transparent text-sm font-regular text-slate-600 dark:text-slate-300 transition duration-150 rounded px-2 py-1
                        focus:outline-none">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="relative">
                                                            <div class="dropdown relative">
                                                                <button class="text-xl text-center block w-full "
                                                                    type="button" id="todoDropdownMenuButton"
                                                ...
                                                <div class="h-full all-todos overflow-x-hidden"
                                                    ...
                                                    <ul
                                                        ...
                                                        <li data-status="team" data-stared="false" data-complete="false"
                                                            ...
                                                            <div class="todo-fav">
                                                                <iconify-icon icon="heroicons:star"
                                                                    class="text-xl leading-[1] relative ">
                                                                </iconify-icon>
                                                            </div>
                                                            <span
                                                                ...
                                                                <span
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <img src=assets/images/avatar/av-1.svg
                                                                                alt=Mahedi Amin
                                                                        ...
                                                                        <div
                                                                            class=" h-6 w-6 rounded-full ring-1 ring-secondary-500 img-active transition-all duration-150">
                                                                            <img src=assets/images/avatar/av-2.svg
                                                                                alt=Sovo Haldar
                                                                                class="w-full h-full rounded-full">
                                                                        </div>
                                                                        ...
                                                                        <div
                                                                            class=" h-6 w-6 rounded-full ring-1 ring-secondary-500 img-active transition-all duration-150">
                                                                            <img src=assets/images/avatar/av-3.svg
                                                                                alt=Rakibul Islam
                                                                                class="w-full h-full rounded-full">
                                                                        </div>
                                                        ...
                                                        <li data-status="stared,low" data-stared="true"
                                                            data-complete="false"
                                                            class="flex items-center px-6 space-x-4 py-6 hover:-translate-y-1 hover:shadow-todo transition-all duration-200 rtl:space-x-reverse">
                                                            <input type="checkbox" class="table-checkbox"
                                                                name="todo-checkbox">
                                                            ...
                                                            <div class="flex">
                                                                <span
                                                                    ...
                                                                    <div>
                                                                        <span
                                                                            class=" bg-opacity-20 capitalize font-normal text-xs leading-4 px-[10px] py-[2px] rounded-full inline-block  bg-success-500 text-success-500  ">
                                                                            low
                                                                        </span>
                                                                    </div>
                                                        ...
                                                        <li data-status="done,stared,medium,low" data-stared="true"
                                                            data-complete="true"
                                                            class="flex items-center px-6 space-x-4 py-6 hover:-translate-y-1 hover:shadow-todo transition-all duration-200 rtl:space-x-reverse">
                                                            <input type="checkbox" class="table-checkbox"
                                                                name="todo-checkbox">
                                                            ...
                                                            <div class="flex">
                                                                <span
                                                                    ...
                                                                    <div>
                                                                        <span
                                                                            class=" bg-opacity-20 capitalize font-normal text-xs leading-4 px-[10px] py-[2px] rounded-full inline-block  bg-warning-500 text-warning-500  ">
                                                                            medium
                                                                        </span>
                                                                    </div>
                                                        ...
                                                        <li data-status="high,low" data-stared="false"
                                                            data-complete="false"
                                                            class="flex items-center px-6 space-x-4 py-6 hover:-translate-y-1 hover:shadow-todo transition-all duration-200 rtl:space-x-reverse">
                                                            <input type="checkbox" class="table-checkbox"
                                                                name="todo-checkbox">
                                                            ...
                                                            <div class="flex">
                                                                <span
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class=" h-6 w-6 rounded-full ring-1 ring-secondary-500 img-active transition-all duration-150">
                                                                            <img src=assets/images/avatar/av-4.svg
                                                                                alt=Sovo Haldar
                                                                                class="w-full h-full rounded-full">
                                                                        </div>
                  ...
                  text-primary-500  ">
                                                        ...
                                                        <li data-status="update" data-stared="false"
                                                            data-complete="false"
                                                            class="flex items-center px-6 space-x-4 py-6 hover:-translate-y-1 hover:shadow-todo transition-all duration-200 rtl:space-x-reverse">
                                                            <input type="checkbox" class="table-checkbox"
                                                                name="todo-checkbox">
                                                            ...
                                                            <div class="flex">
                                                                <span
                                                                    ...
                                                                    <div>
                                                                        <span
                                                                            class=" bg-opacity-20 capitalize font-normal text-xs leading-4 px-[10px] py-[2px] rounded-full inline-block  bg-info-500 text-info-500  ">
                                                                            update
                                                                        </span>
                                                                    </div>
                                                        ...
                                                        <li class="mx-6 mt-6 " id="no-result">
                                                            <span
                                                                class="badge bg-danger-500 text-white w-full block text-start">
                                                                <span class="inline-flex items-center">No Result
                                                                    Found</span>
                                                            </span>
                                                        </li>
                                                    </ul>
                                ...
                                <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
                                    id="newTodoModal" tabindex="-1" aria-labelledby="newTodoModalLabel"
                                    aria-hidden="true">
                                                ...
                                                <div class="p-6 space-y-4">
                                                    <form class="flex flex-col space-y-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <select name="assigned" id="assigneds"
                                                                class="form-control w-full mt-2 py-2">
                                                        ...
                                                        <div>
                                                            <label for="default-picker" class=" form-label">Default
                                                                Functionality</label>
                                                            <input
                                                                class="form-control py-2 flatpickr flatpickr-input active"
                                                                id="default-picker" value="" type="text"
                                                                readonly="readonly">
                                                        </div>
                                                        <div>
                                                            <label for="tags" class="form-label">Tag</label>
                                                            <select name="tags" id="tagss"
                                                                class="form-control w-full mt-2 py-2">
                                                                <option value="option1"
                                                                    class=" inline-block font-Inter font-normal text-sm text-slate-600">
                                                                    Option 1</option>
                                ...
                                <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
                                    id="editTodoModal" tabindex="-1" aria-labelledby="editTodoModalLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog relative w-auto pointer-events-none">
                                        <div
                                                ...
                                                <div class="p-6 space-y-4">
                                                    <form class="flex flex-col space-y-3">
                                                        <div class="input-area">
                                                            <label for="title" class="form-label">Title</label>
                                                            <input id="title" type="text" class="form-control"
                                                                value="Task 01" placeholder="Enter Title">
                                                        </div>
                                                        <div>
                                                            <label for="assigned" class="form-label">Assignee</label>
                                                            <select name="assigned" id="assigneds"
                                                        ...
                                                        <div class="input-area">
                                                            <label for="textarea" class="form-label">Description</label>
                                                            <textarea name="textarea" id="textarea" rows="3"
                                                                class="form-control" value="Lorem ipsum dolor sit amet."
                                                                placeholder="Enter Title">
                                </textarea>
                                                        </div>
                                                        <div

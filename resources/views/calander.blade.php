                    ...
                    <div class="transition-all duration-150 container-fluid" id="page_layout">
                        <div id="content_layout">
                            <div>
                                ...
                                <!-- END: BreadCrumb -->
                                <div class="CAOnBoarding-calender">
                                    <div class="grid grid-cols-12 gap-4">
                                        <div class="lg:col-span-3 col-span-12 card p-6">
                                            ...
                                            <div
                                                class="block py-4 text-slate-800 dark:text-slate-400 font-semibold text-xs uppercase mt-4">
                                                FILTER
                                            </div>
                                            <ul class="space-y-2">
                                                <li>
                                                    <div class="checkbox-area primary-checkbox">
                                                        <label class="inline-flex items-center cursor-pointer">
                                                            <input type="checkbox" class="hidden" name="category"
                                                                checked value="all">
                                        ...
                                        transition-all duration-150 bg-slate-100 dark:bg-slate-900">
                                                            ...
                                                            <span
                                                                class="text-slate-500 dark:text-slate-400 text-sm leading-6">All</span>
                                                        </label>
                                                    </div>
                                                </li>
                                                <li>
                                        ...
                                        transition-all duration-150 bg-slate-100 dark:bg-slate-900">
                                                            ...
                                                            <span
                                                                class="text-slate-500 dark:text-slate-400 text-sm leading-6">Business</span>
                                                        </label>
                                                    </div>
                                                </li>
                                                <li>
                                        ...
                                        transition-all duration-150 bg-slate-100 dark:bg-slate-900">
                                                            ...
                                                            <span
                                                                class="text-slate-500 dark:text-slate-400 text-sm leading-6">personal</span>
                                                        </label>
                                                    </div>
                                                </li>
                                                <li>
                                        ...
                                        transition-all duration-150 bg-slate-100 dark:bg-slate-900">
                                                            ...
                                                            <span
                                                                class="text-slate-500 dark:text-slate-400 text-sm leading-6">Holiday</span>
                                                        </label>
                                                    </div>
                                                </li>
                                                <li>
                                        ...
                                        transition-all duration-150 bg-slate-100 dark:bg-slate-900">
                                                            ...
                                                            <span
                                                                class="text-slate-500 dark:text-slate-400 text-sm leading-6">family</span>
                                                        </label>
                                                    </div>
                                                </li>
                                                <li>
                                        ...
                                        transition-all duration-150 bg-slate-100 dark:bg-slate-900">
                                                            ...
                                                            <span
                                                                class="text-slate-500 dark:text-slate-400 text-sm leading-6">meeting</span>
                                                        </label>
                                                    </div>
                                                </li>
                                                <li>
                                        ...
                                        transition-all duration-150 bg-slate-100 dark:bg-slate-900">
                                                            ...
                                                            <span
                                                                class="text-slate-500 dark:text-slate-400 text-sm leading-6">etc</span>
                                                        </label>
                                                    </div>
                                                </li>
                                            </ul>
                                ...
                                <div class=" addmodal-wrapper " id="addeventModal">
                                    ...
                                    <div class="modal-content">
                                        <div class="flex min-h-full justify-center text-center p-6 items-start ">
                                            <div
                                                class="w-full transform overflow-hidden rounded-md bg-white dark:bg-slate-800 text-left align-middle shadow-xl transition-alll max-w-xl opacity-100 scale-100">
                                                <div
                                                    class="relative overflow-hidden py-4 px-5 text-white flex justify-between bg-slate-900 dark:bg-slate-800 dark:border-b dark:border-slate-700">
                                                    <h2
                                                    ...
                                                    <form id="add-event-form" class="space-y-5">
                                                        <div class="fromGroup">
                                                            ...
                                                            <input type="text" id="event-title" name="event-title"
                                                                placeholder="Add Title" class="form-control" required>
                                                        </div>
                                                        <div class="fromGroup">
                                                            <label for="event-start-date" class=" form-label">Start
                                                                Date</label>
                                                            <input class="form-control py-2 startdate"
                                                                id="event-start-date" type="text">
                                                        </div>
                                                        <div class="fromGroup">
                                                            <label for="event-end-date" class=" form-label">End
                                                                Date</label>
                                                        ...
                                                        <div class="text-right">
                                                            <button type="submit" id="submit-button"
                                                                class="btn btn-dark">Add Event</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>

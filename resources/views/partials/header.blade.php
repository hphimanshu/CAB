...
<div class="z-[9]" id="app_header">
            ...
            <div class="flex justify-between items-center h-full">
              <div class="flex items-center md:space-x-4 space-x-2 xl:space-x-0 rtl:space-x-reverse vertical-box">
                <a href="index.html" class="mobile-logo xl:hidden inline-block">
                  <img src="{{ asset('assets/images/logo/logo-c.svg') }}" alt="Logo">
                  <img src="{{ asset('assets/images/logo/logo-c-white.svg') }}" alt="Logo">
                </a>
      ...
      overflow-hidden">
            ...
            dark:text-white font-normal">
                      ...
                      <li>
                        <a href="{{ route('profile') }}" class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
            ...
            dark:text-white font-normal">
                      ...
                      <li>
                        <a href="{{ route('settings') }}" class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
                      ...
                      @csrf
                      <button type="submit" class="w-full text-left block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600 dark:text-white font-normal">
